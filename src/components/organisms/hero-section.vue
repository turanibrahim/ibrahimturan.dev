...
<template>
  <section class=" relative py-10 overflow-hidden">
    ...
    <div class="container">
      <v-card
        class="relative z-10 bg-base-200/50 backdrop-blur-xs"
        bordered
      >
        <div class="flex flex-col md:flex-row print:flex-row gap-5 lg:gap-10 md:items-center h-full min-h-[300px]">
