...
export const ExperienceCard = ({
  ...
  <VCard bordered className="bg-base-100">
    <div className="flex flex-col gap-6 md:flex-row">
      <div className="shrink-0">
        <VCompanyLogo src={experience.companyLogo} alt={`${experience.company} logo`} />
      </div>

      <div className="min-w-0 grow space-y-3">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div>
            <VHeading level="3" weight="semibold" className="text-secondary">
              {experience.title}
            </VHeading>
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-base-content-muted">
          ...
          <span aria-hidden="true" className="text-base-content-muted/60">
            •
          </span>
        ...
        <div
          className="prose prose-sm max-w-none text-base-content leading-relaxed [&_li]:before:mr-2 [&_li]:before:font-bold [&_li]:before:text-primary [&_li]:before:content-['•_'] [&_ul]:list-none [&_ul]:pl-0"
